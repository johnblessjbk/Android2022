...
public class DoctorMedicalAdaptor extends ArrayAdapter<DataModel> {
    ImageView image;
    ...
    public DoctorMedicalAdaptor(Activity context, List<DataModel> prodList) {
        super( context, R.layout.activity_doctor_medical_adaptor,prodList);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View view = inflater.inflate(R.layout.activity_doctor_medical_adaptor, null, true);
